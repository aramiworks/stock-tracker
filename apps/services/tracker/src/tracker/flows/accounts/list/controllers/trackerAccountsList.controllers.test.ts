...
describe("TrackerAccountsListControllers", () => {
  let ctrl: TrackerAccountsListControllers;
  ...
  beforeEach(async () => {
    ...
    ctrl = module.get(TrackerAccountsListControllers);
  });
  ...
  describe("all()", () => {
    it("returns mapped accounts from database", async () => {
      ...
      expect(mockPrisma.tracker_accounts.findMany).toHaveBeenCalledWith({
    ...
    it("returns empty array when no accounts exist", async () => {
      (mockPrisma.tracker_accounts.findMany as any).mockResolvedValue([]);
  ...
  describe("create()", () => {
    it("creates an account with required fields", async () => {
      ...
      expect(mockPrisma.tracker_accounts.create).toHaveBeenCalledWith({
        data: {
          auth_user_id: TEST_USER_ID,
