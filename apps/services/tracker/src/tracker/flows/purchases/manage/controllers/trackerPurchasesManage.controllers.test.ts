...
describe("TrackerPurchasesManageControllers", () => {
  let ctrl: TrackerPurchasesManageControllers;
  ...
  beforeEach(async () => {
    ...
    const module = await Test.createTestingModule({
      providers: [
        TrackerPurchasesManageModels,
        TrackerPurchasesManageControllers,
        { provide: PrismaService, useValue: mockPrisma },
      ],
    }).compile();
    ctrl = module.get(TrackerPurchasesManageControllers);
  });
  ...
  describe("byId()", () => {
    ...
    it("throws NOT_FOUND for missing purchase", async () => {
      (mockPrisma.tracker_purchases.findUnique as any).mockResolvedValue(null);
  ...
  describe("create()", () => {
    it("creates a purchase for owned account", async () => {
      ...
      expect(mockPrisma.tracker_purchases.create).toHaveBeenCalled();
    });
  ...
  describe("update()", () => {
    it("updates a purchase", async () => {
      ...
      expect(mockPrisma.tracker_purchases.update).toHaveBeenCalled();
  ...
  describe("delete()", () => {
    it("deletes a purchase", async () => {
      ...
      expect(mockPrisma.tracker_purchases.delete).toHaveBeenCalledWith({
