/**
 * Generates apps/subgraphs/auth/schema.graphql from the in-source typeDefs.
 *
 ...
 *
 * Run via `npm run print-schema -w @stock-tracker/subgraph-auth` or as part of the
...
const schema = buildSubgraphSchema([{ typeDefs: authTypeDefs }]);
